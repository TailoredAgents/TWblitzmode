...
- Backend: OPENAI_API_KEY, PRIMARY_MODEL=gpt-4.1, APIFY_TOKEN, PHANTOMBUSTER_API_KEY (optional/secondary), CUFINDER_API_KEY, SENDGRID_API_KEY, SENDGRID_VERIFIED_SENDER, DATABASE_URL, webhook secrets.
