...
CREATE TABLE IF NOT EXISTS tenant_email_settings (
    ...
    CONSTRAINT fk_tenant_email_settings_tenant FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS email_costs (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_email_costs_tenant FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS email_suppression_list (
    ...
    CONSTRAINT fk_email_suppression_tenant FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS email_webhook_events (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_email_webhook_tenant FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS tenant_sendgrid_subusers (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_sendgrid_subusers_tenant FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS tenant_domain_authentication (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_domain_auth_tenant FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE,
